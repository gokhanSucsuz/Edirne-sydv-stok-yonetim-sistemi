          ...
          {personnel && (
            <div className="p-4 border-t border-gray-200">
              ...
              <Link
                href="/profile"
                onClick={() => setSidebarOpen(false)}
                className="w-full flex items-center px-2 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md mb-1"
              >
        ...
        <div className="flex flex-col w-64 border-r border-gray-200 bg-white">
          ...
          {personnel && (
            <div className="p-4 border-t border-gray-200 bg-gray-50">
              ...
              <Link
                href="/profile"
                className="w-full flex items-center px-2 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md transition-colors mb-1"
              >
                <UserIcon className="mr-3 h-5 w-5 text-gray-400" />
                Profilim
              </Link>
